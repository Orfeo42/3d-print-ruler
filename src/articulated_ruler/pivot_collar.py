...
COLLAR_TAB_SQUEEZE_DEPTH: float = (
    0.25  # how far the bulge dips inside the bead's outer reach - the actual snap interference
)
COLLAR_TAB_MOUTH_ANGLE_DEG: float = (
    50.0  # where on the groove circle the inner edge lands (0 = the circle's outermost point)
)
